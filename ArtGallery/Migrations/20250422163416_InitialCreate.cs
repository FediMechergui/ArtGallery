        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechniqueUsed = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoldenBookEntries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCarts_Artworks_ArtworkId",
                        column: x => x.ArtworkId,
                        principalTable: "Artworks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtworkCategories", x => new { x.ArtworksId, x.CategoriesId });
                    table.ForeignKey(
                        name: "FK_ArtworkCategories_Artworks_ArtworksId",
                        column: x => x.ArtworksId,
                        principalTable: "Artworks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtworkCategories_Categories_CategoriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtworkCategories_CategoriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCarts_ArtworkId",
                table: "ShoppingCarts",
                column: "ArtworkId");
